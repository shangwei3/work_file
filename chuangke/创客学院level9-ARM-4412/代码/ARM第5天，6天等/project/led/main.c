	 ...
	 while(1)
	 {
		...
		switch(i)
		{
		 	case 0:
				...
				REG_WRITE(GPF3CON,REG_READ(GPF3CON)&(~(0XF<<16))|(0X1<<16));
				REG_WRITE(GPF3DAT,REG_READ(GPF3DAT)&(0X0<<4));
				REG_WRITE(GPF3CON,REG_READ(GPF3CON)&(~(0XF<<20))|(0X1<<20));
				REG_WRITE(GPF3DAT,REG_READ(GPF3DAT)&(0X0<<5));
				break;
			case 1:
				REG_WRITE(GPX2CON,REG_READ(GPX2CON)&(~(0XF<<28))|(0X1<<28));
				REG_WRITE(GPX2DAT,REG_READ(GPX2DAT)|(0X1<<7));
			...
			case 2:
				...
				REG_WRITE(GPX1DAT,REG_READ(GPX1DAT)|(0X1));
				REG_WRITE(GPF3CON,REG_READ(GPF3CON)&(~(0XF<<16))|(0X1<<16));
				REG_WRITE(GPF3DAT,REG_READ(GPF3DAT)|(0X1<<4));
				REG_WRITE(GPF3CON,REG_READ(GPF3CON)&(~(0XF<<20))|(0X1<<20));
				REG_WRITE(GPF3DAT,REG_READ(GPF3DAT)&(0X0<<5));
			    break;
			case 3:
				...
				REG_WRITE(GPF3DAT,REG_READ(GPF3DAT)|(0X1<<4));
				REG_WRITE(GPF3CON,REG_READ(GPF3CON)&(~(0XF<<20))|(0X1<<20));
				REG_WRITE(GPF3DAT,REG_READ(GPF3DAT)|(0X1<<5));
				break;
		}
		i++;
		if(i==4)
