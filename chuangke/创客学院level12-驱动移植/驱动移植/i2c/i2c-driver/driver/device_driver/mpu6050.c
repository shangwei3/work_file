...
static int mpu6050_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	mpu6050_write_byte(client, PWR_MGMT_1, 0x00);//唤醒
...
/*
 *注意:这个驱动并没有导出设备号信息，也就是说不会在用户空间创建设备节点
 *     如果想执行app目录下的test程序，必须先在开发板上的dev目录创建设备节点
 *     例如:mknod /dev/mpu6050 c 251 0
 *
 */
